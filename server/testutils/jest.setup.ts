...
const apiSpecPath = path.join(__dirname, '..', '..', 'tmp', 'sas-api.json')

const apiSpecUrl =
  process.env.SAS_API_SPEC_URL ||
  'https://single-accommodation-service-api-dev.hmpps.service.justice.gov.uk/v3/api-docs'
