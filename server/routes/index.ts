...
export default function routes(services: Services): Router {
  ...
  router.post(uiPaths.proposedAddresses.type.pattern, proposedAddressesController.type())
  router.post(uiPaths.proposedAddresses.status.pattern, proposedAddressesController.status())
  router.post(uiPaths.proposedAddresses.checkYourAnswers.pattern, proposedAddressesController.checkYourAnswers())
